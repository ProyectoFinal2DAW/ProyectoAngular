    ...
    async onSubmitCrearExperimento() {
        ...
        if (this.action === 'u') {
            ...
            if (!this.selectedFile) {
                ...
                rutaImg = "https://monlab.alumnes-monlau.com/images" + this.selectedFile?.name;
            }
            let rutaVideo = "";
            if (!this.selectedVideoFile) {
            ...
            const newExperimento: NewExperimento = {
                nombre_experimento: this.addExperimentForm.value.nombreExperimento,
                descrip_experimento: this.addExperimentForm.value.descripcionExperimento,
                foto_experimento: "https://monlab.alumnes-monlau.com/images" + this.selectedFile?.name,
                video_experimento: "https://monlab.alumnes-monlau.com/images" + this.selectedVideoFile?.name,
            };
